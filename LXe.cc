...
#ifdef G4VIS_USE
    UImanager->ApplyCommand("/control/execute run_vis.mac");
    //UImanager->ApplyCommand("/control/execute run_cosmic__module_chips_detector.mac");
    //UImanager->ApplyCommand("/control/execute myRun.mac");  
    //UImanager->ApplyCommand("/control/execute myRun_cosmic_chips_module.mac");
#endif
    ui->SessionStart();
    delete ui;
#endif
